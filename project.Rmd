...
The dataset should already exist and not be data from your lab or that you have worked with before. 
...
1.  Proposal - due [Monday July 18th]
2.  Presentation - due [Thursday July 28th]
3.  Executive summary - due [Friday July 29th @ start of class]
...
15 minutes maximum, and each team member should say something substantial.
...
There isn't a limit to how many slides you can use, just a time limit (15 minutes total).
...
Presentations will take place during the last few workshop of the semester.
You can choose to do your presentation live or pre-record it.
You will watch presentations from other teams and provide feedback in the form of peer evaluations.
...
Filling out the survey is a prerequisite for getting credit on the team member evaluation. If you are suggesting that an individual did less than 25% of the work, please provide some explanation.
If any individual gets an average peer score indicating that they did less than 15% of the work, this person will receive half the grade of the rest of the group.
